import{s as S,C as B,u as G,r as K,a as e,j as a,G as j,ag as R,aF as W}from"./index.9af5e57e.js";import{u as A}from"./i18n.hooks.95fc6568.js";import{B as D}from"./Button.cf3005dc.js";import{u as q,L as H}from"./Layout.container.9056670d.js";import{f as J}from"./file-download.9541e5f9.js";import{c as Q,e as V,s as Z}from"./users.service.hooks.69e80bb1.js";import{S as E}from"./sweetalert2.all.96059b0d.js";import{n as m}from"./common.utils.106d572f.js";import"./auth.service.hooks.6abcf1c4.js";const ee="/CodiShark/assets/iconUserPhoto.6809db68.svg",{BREAKPOINTS:r}=B,te=S.div`
  .ProofPayment {
    &__separator {
      &--paragraph {
        display: flex;
...
`,L=p=>{const c=A().pages.AdminPaymentDetails.card,{id:t}=W();return e(ae,{className:"PaymentDetails",children:a("div",{className:"PaymentDetails__container--components",children:[(()=>e("div",{className:"PaymentDetails__component--card",children:a(j,{children:[e("div",{className:"PaymentDetails__container--card-image",children:e("img",{src:ee,alt:c.alt,className:"PaymentDetails__container--image"})}),a("div",{className:"PaymentDetails__container--card-text",children:[e("p",{className:"PaymentDetails__text--title",children:c.title.toLocaleUpperCase()}),e("p",{className:"PaymentDetails__text--subtitle",children:c.subtitle})]})]})}))(),e(I,{operationId:parseInt(t!=null?t:"")})]})})};L.defaultProps={};const T=p=>e(H,{children:e(L,{})});T.defaultProps={};const he=T;export{he as default};
