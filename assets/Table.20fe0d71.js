...
`,Mn=b.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var _n=n.exports.memo(function({column:e,disabled:t,draggingColumnId:o,selectedColumn:a={},sortDirection:r,sortIcon:i,sortServer:s,pagination:c,paginationServer:u,persistSelectedOnSort:f,selectableRowsVisibleOnly:p,onSort:x,onDragStart:P,onDragOver:C,onDragEnd:w,onDragEnter:$,onDragLeave:R}){n.exports.useEffect(()=>{typeof e.selector=="string"&&console.error(`Warning: ${e.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)},[]);const[D,F]=n.exports.useState(!1),S=n.exports.useRef(null);if(n.exports.useEffect(()=>{S.current&&F(S.current.scrollWidth>S.current.clientWidth)},[D]),e.omit)return null;const O=()=>{if(!e.sortable&&!e.selector)return;let k=r;be(a.id,e.id)&&(k=r===X.ASC?X.DESC:X.ASC),x({type:"SORT_CHANGE",sortDirection:k,selectedColumn:e,clearSelectedOnSort:c&&u&&!f||s||p})},L=k=>n.exports.createElement(Tn,{sortActive:k,sortDirection:r}),M=()=>n.exports.createElement("span",{className:[r,"__rdt_custom_sort_icon__"].join(" ")},i),y=!(!e.sortable||!be(a.id,e.id)),v=!e.sortable||t,U=e.sortable&&!i&&!e.right,_=e.sortable&&!i&&e.right,N=e.sortable&&i&&!e.right,Y=e.sortable&&i&&e.right;return n.exports.createElement(jn,{"data-column-id":e.id,className:"rdt_TableCol",headCell:!0,allowOverflow:e.allowOverflow,button:e.button,compact:e.compact,grow:e.grow,hide:e.hide,maxWidth:e.maxWidth,minWidth:e.minWidth,right:e.right,center:e.center,width:e.width,draggable:e.reorder,isDragging:be(e.id,o),onDragStart:P,onDragOver:C,onDragEnd:w,onDragEnter:$,onDragLeave:R},e.name&&n.exports.createElement(Ln,{"data-column-id":e.id,"data-sort-id":e.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:v?void 0:O,onKeyPress:v?void 0:k=>{k.key==="Enter"&&O()},sortActive:!v&&y,disabled:v},!v&&Y&&M(),!v&&_&&L(y),typeof e.name=="string"?n.exports.createElement(Mn,{title:D?e.name:void 0,ref:S,"data-column-id":e.id},e.name):e.name,!v&&N&&M(),!v&&U&&L(y)))});const An=b(de)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
