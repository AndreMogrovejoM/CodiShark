...
`,de=t=>{const a=re().signIn.SignInFormUser,[l,r,o]=rt(),[n,g]=V.exports.useState(!1),{setSignInStep:I,setUser:S}=J(),{mutateAsync:_,reset:v}=Xe(),{control:w,handleSubmit:x}=Pe();return d(Tt,{className:"SignInForm",children:P(ne,{component:"form",noValidate:!0,onSubmit:x(async h=>{try{g(!0);const m={dni:h==null?void 0:h.dni,cod_verifier:h==null?void 0:h.cod,emision_date:h==null?void 0:h.date_begin};await _(m).then(F=>S(F)),v(),g(!1),I(1)}catch{g(!1)}}),children:[P(G,{container:!0,spacing:2,children:[d(G,{item:!0,xs:8,md:8,children:d(le,{name:l.name,control:w,rules:l.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:l.type,label:l.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0,maxLength:l==null?void 0:l.maxLength,InputProps:{endAdornment:d(_e,{position:"end",children:d("img",{className:"SignInForm__icon",src:at,alt:"iconPerson"})})}}})})}),d(G,{item:!0,xs:4,md:4,children:d(le,{name:r.name,control:w,rules:r.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:r.type,label:r.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0,maxLength:r==null?void 0:r.maxLength,InputProps:{endAdornment:d(_e,{position:"end",children:d("img",{className:"SignInForm__icon",src:Lt,alt:"iconAlert"})})}}})})}),d(G,{item:!0,xs:12,md:12,children:d(le,{name:o.name,control:w,rules:o.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:o.type,label:o.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0}})})})]}),d(ne,{children:d(me,{type:"submit",variant:"contained",size:"large",color:"info",fullWidth:!0,disabled:n,className:"SignInForm__container--button",children:a.button})})]})})};de.defaultProps={};const Bt=ae.div`
  .SignInValidate {
    &__container {
      &--button {
        padding: 1rem 0;
...
`,Le=t=>{const a=re().signIn.SignInValidation,l=it(),[r,o]=V.exports.useState(!1),{setSignInStep:n,user:g,setSignInMethod:I}=J(),{register:S,handleSubmit:_}=Pe(),{mutateAsync:v,reset:w}=Ce(),{first_name:x,last_name:b,phone:h,email:m}=g!=null?g:{},F=async k=>{try{o(!0),await v({dni:g==null?void 0:g.dni,type:k==null?void 0:k.verifyMethod}),w(),I(k==null?void 0:k.verifyMethod),o(!1),n(2)}catch{o(!1)}},$=k=>{const{id:A,value:T,label:B,name:q,labelExtension:E}=k;return d("div",{children:P("label",{htmlFor:A,children:[d("input",{className:"SignInValidate__container__input",type:"radio",value:T,id:A,...S(q,{required:!0})}),B,d("span",{className:"SignInValidate__text--color",children:E})]})})},C=()=>P("form",{onSubmit:_(F),children:[d("div",{className:"SignInValidate__container__form",children:l.map((k,A)=>{var T,B;return d($,{id:k.id,name:k.name,value:k.value,label:k.label,labelExtension:k.value==="SMS"?` *** *** ${(T=h==null?void 0:h.slice((h==null?void 0:h.length)-3))!=null?T:""}`:` ********${(B=m==null?void 0:m.slice((m==null?void 0:m.length)-15))!=null?B:""}`},A)})}),d(me,{type:"submit",variant:"contained",size:"large",color:"info",fullWidth:!0,disabled:r,className:"SignInValidate__container--button",children:a.button})]});return d(Bt,{className:"SignInValidate",children:P("div",{className:"SignInValidate__container__global",children:[d("div",{className:"SignInValidate__container",children:(()=>P(Oe,{children:[P("p",{className:"SignInValidate__text--greeting",children:[a.greeting,d("span",{className:"SignInValidate__text--greeting__bold",children:` ${x!=null?x:""} ${b!=null?b:""}`})]}),d("p",{className:"SignInValidate__text--indication",children:a.instructions})]}))()}),C()]})})};Le.defaultProps={};const Et="/CodiShark/assets/loginImageUser.fd914332.jpg",Vt="/CodiShark/assets/loginImageUser.93122b01.webp",Rt=ae.div`
  .SignIn {
    &__renderList {
      width: 48%;
      margin-left: 4rem;
...
`,{ENTRY_PATH:Dt}=pe.ROUTES,Te=t=>{const{isAnonymous:a,signInStep:l}=J(),r=re().signIn.SignInFormUser,o=ke();V.exports.useEffect(()=>{if(!a){o(Dt);return}},[a,o]);const n=()=>{switch(l){case 0:return d(de,{});case 1:return d(Le,{});case 2:return d(Fe,{});default:return d(de,{})}},g=()=>P(Oe,{children:[d("img",{src:Ct,alt:r.altLogo}),d("h1",{className:"SignIn__title",children:l!==2?r.title.toUpperCase():r.titleAlt.toUpperCase()}),d("p",{className:"SignIn__subtitle",children:l!==2?r.subtitle:r.subtitleAlt}),l===2&&d("p",{className:"SignIn__subtitle",children:r.subtitleAltTwo})]}),I=()=>d("p",{className:"SignIn__container--copyright",children:r.copyright});return d(Rt,{className:"SignIn",children:P(G,{container:!0,component:"main",className:"SignIn__container",children:[d(G,{item:!0,xs:!1,sm:4,md:6,className:"SignIn__image",children:(()=>P("div",{className:"SignIn__renderList",children:[d("h2",{className:"SignIn__renderList--h2",children:r.benefitTitle}),d("h1",{className:"SignIn__renderList--h1",children:r.benefitSubTitle}),P("ul",{className:"SignIn__renderList--ul",children:[d("li",{className:"SignIn__renderList--h2",children:r.ul1}),d("li",{className:"SignIn__renderList--h2",children:r.ul2}),d("li",{className:"SignIn__renderList--h2",children:r.ul3}),d("li",{className:"SignIn__renderList--h2",children:r.ul4})]})]}))()}),P(G,{item:!0,xs:12,sm:8,md:6,component:Je,elevation:4,square:!0,container:!0,alignItems:"center",justifyContent:"center",flexDirection:"column",children:[P(ne,{className:"SignIn__container--form",children:[d(ne,{className:"SignIn__container--center   SignIn__container--content",children:g()}),n()]}),I()]})]})})};Te.defaultProps={};const qt=Te;export{qt as default};
