import{B as P}from"./Button.a4f8297e.js";import{P as E,R as f,b as O,S as M}from"./PaymentTable.helpers.ff43fc94.js";import{S as Y}from"./SkeletonComponent.c6acbb5d.js";import{u as y,g as K}from"./i18n.hooks.b934c051.js";import{f as v}from"./file-download.9541e5f9.js";import{s as N,C as w,r as D,a,j as r,ag as A}from"./index.e172364c.js";import{f as H,g as F,h as G}from"./administrator.service.hooks.473b8de9.js";import{T as q}from"./Table.e7519fcc.js";import{p as Q,c as J}from"./validations.utils.2772fe45.js";import{g as W,a as X,b as Z}from"./common.utils.cf38e105.js";import{L as ee}from"./Layout.container.28d71187.js";import"./auth.service.hooks.491fdc41.js";const{BREAKPOINTS:k}=w,te=N.div`
  .Pagination {
...
`,L=t=>{const{rowsPerPage:e,rowCount:n,onChangeRowsPerPage:m}=t,{currentPage:s,onChangePage:l}=t,o=y().global.table.TablePaymentUser.Pagination,d=X(n,e),g=W(d),h=s*e-e+1,p=s===1,b=s===d,U=D.exports.useCallback(()=>l(s-1),[s,l]),c=D.exports.useCallback(()=>l(s+1),[s,l]),V=D.exports.useCallback(i=>l(i),[l]),B=i=>a("div",{...i,children:i==null?void 0:i.value}),I=o.legend(h,n,n),C=i=>`Pagination__text--bold ${i?"Pagination__text--disabled":""}`,j=i=>`Pagination__container--numbers ${i===s?"Pagination__container--numbers-activated":""}`;return a(te,{className:"Pagination",children:r("div",{className:"Pagination__container",children:[a("p",{className:"Pagination__text",children:I}),r("div",{className:"Pagination__container--pagination",children:[a("button",{className:C(p),"aria-disabled":p,onClick:U,disabled:p,children:o.back}),g.map((i,z)=>a(B,{value:i,className:j(i),onClick:()=>V(i)},z)),a("button",{className:C(b),"aria-disabled":b,onClick:c,disabled:b,children:o.next})]})]})})};L.defaultProps={};const ae=t=>a(L,{...t}),T=t=>{const{data:e,columns:n,onRowClicked:m,progressPending:s}=t;return a(E,{className:"PaymentTable",children:a(q,{columns:n,data:e,paginationPerPage:Q,paginationRowsPerPageOptions:J,onRowClicked:m,paginationComponent:ae,progressPending:s})})};T.defaultProps={};const ne="/CodiShark/assets/usersIcon.6275cb21.svg",re=t=>t==="M"?"Masculino":"Femenino",{BREAKPOINTS:se}=w,ie=N.div`
  .UserDetails {
    &__container {
      &--separate {
