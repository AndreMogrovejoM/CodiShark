...
`,{ENTRY_PATH:Pt}=Z.ROUTES,{INTERVAL:At,INITIAL_TIME:Et}=Z,Te=t=>{const o=le().signIn.SignInFormCode,[u,n]=R.exports.useState(!1),[l,r]=R.exports.useState(""),f=Oe(),{setSignInStep:b,user:h,setUser:I}=te(),{signInMethod:g}=te(),[,x]=nt("user"),{mutateAsync:w,reset:y}=Ae(),{mutateAsync:$,reset:v}=it(),[N,{start:C}]=kt(Et,At),_=F=>r(F),L=async()=>{try{n(!0),w({dni:h==null?void 0:h.dni,type:g}),C(),y(),n(!1)}catch{n(!1)}},O=async()=>{try{n(!0),await $({password:l,dni:h==null?void 0:h.dni}).then(F=>{const{access_token:V,user:D}=F!=null?F:{};I(D),x(D),ot.setCookie("token",V)}),v(),n(!1),b(0),f(Pt)}catch{n(!1)}},T=()=>i("span",{className:"SignInCode__container--separator"});return R.exports.useEffect(()=>{C()},[C]),P(Ot,{className:"SignInCode",children:[i($t,{value:l,onChange:_,numInputs:at,separator:T(),containerStyle:"SignInCode__container--OTP",inputStyle:"SignInCode__input SignInCode__input--text",focusStyle:"SignInCode__input--focus"}),i("div",{className:"SignInCode__container--time",children:P("p",{className:"SignInCode__text SignInCode__text--time",children:["(",ut(N/1e3),")"]})}),i("div",{className:"SignInCode__container--button",children:i(ve,{variant:"contained",size:"large",color:"info",fullWidth:!0,onClick:O,disabled:u,className:"SignInCode__component--button",children:o.button})}),P("div",{className:"SignInCode__container--text",children:[P("p",{className:"SignInCode__text",children:[`${o.question} `,i("span",{onClick:L,className:"SignInCode__text--color SignInCode__text--clickable",children:o.answer})]}),i("p",{className:"SignInCode__text SignInCode__text--clickable",onClick:()=>b(1),children:o.method})]})]})};Te.defaultProps={};const Ft="/CodiShark/assets/iconAlertSignIn.6a29537a.svg",Lt=ce.div`
  .SignInForm {
    &__container {
      &--button {
        margin-top: 2.4rem;
...
`,Ve=t=>{const o=le().signIn.SignInValidation,u=lt(),[n,l]=R.exports.useState(!1),{setSignInStep:r,user:f,setSignInMethod:b}=te(),{register:h,handleSubmit:I}=Ee(),{mutateAsync:g,reset:x}=Ae(),{first_name:w,last_name:y,phone:$,email:v}=f!=null?f:{},N=async O=>{try{l(!0),await g({dni:f==null?void 0:f.dni,type:O==null?void 0:O.verifyMethod}),x(),b(O==null?void 0:O.verifyMethod),l(!1),r(2)}catch{l(!1)}},C=O=>{const{id:T,value:F,label:V,name:D,labelExtension:B}=O;return i("div",{children:P("label",{htmlFor:T,children:[i("input",{className:"SignInValidate__container__input",type:"radio",value:F,id:T,...h(D,{required:!0})}),V,i("span",{className:"SignInValidate__text--color",children:B})]})})},_=()=>P(Pe,{children:[P("p",{className:"SignInValidate__text--greeting",children:[`${o.greeting} `,i("span",{className:"SignInValidate__text--greeting__bold SignInValidate__text--block",children:`${w!=null?w:""} ${y!=null?y:""}`})]}),i("p",{className:"SignInValidate__text--indication",children:o.instructions})]});return i(Tt,{className:"SignInValidate",children:i("div",{className:"SignInValidate__container__global",children:(()=>P("form",{onSubmit:I(N),children:[P("div",{className:"SignInValidate__container__form",children:[_(),u.map((O,T)=>{var F,V;return i(C,{id:O.id,name:O.name,value:O.value,label:O.label,labelExtension:O.value==="SMS"?` *** *** ${(F=$==null?void 0:$.slice(($==null?void 0:$.length)-3))!=null?F:""}`:` *** *** ${(V=v==null?void 0:v.slice((v==null?void 0:v.length)-15))!=null?V:""}`},T)})]}),i("div",{className:"SignInValidate__container--button",children:i(ve,{type:"submit",variant:"contained",size:"large",color:"info",fullWidth:!0,disabled:n,className:"SignInValidate__component--button",children:o.button})})]}))()})})};Ve.defaultProps={};const Vt="/CodiShark/assets/loginImageUser.fd914332.jpg",Bt="/CodiShark/assets/loginImageUser.93122b01.webp",{BREAKPOINTS:E}=Z,$e=ce.div`
  display: flex;
  flex-direction: column;
