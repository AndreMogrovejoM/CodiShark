...
`,{ENTRY_PATH:bt}=pe.ROUTES,{INTERVAL:xt,INITIAL_TIME:wt}=pe,ke=t=>{const a=ie().signIn.SignInFormCode,[d,r]=D.exports.useState(!1),[c,n]=D.exports.useState(""),m=xe(),{setSignInStep:b,user:h,setUser:_}=Q(),{signInMethod:S}=Q(),[,w]=He("user"),{mutateAsync:x,reset:y}=Ce(),{mutateAsync:k,reset:v}=Ye(),[C,{start:N}]=_t(wt,xt),I=E=>n(E),F=async()=>{try{r(!0),x({dni:h==null?void 0:h.dni,type:S}),N(),y(),r(!1)}catch{r(!1)}},P=async()=>{try{r(!0),await k({password:c,dni:h==null?void 0:h.dni}).then(E=>{const{access_token:V,user:R}=E!=null?E:{};_(R),w(R),Ze.setCookie("token",V)}),v(),r(!1),b(0),m(bt)}catch{r(!1)}},L=()=>l("span",{className:"SignInCode__container--separator"});return D.exports.useEffect(()=>{N()},[N]),A(yt,{className:"SignInCode",children:[l(It,{value:c,onChange:I,numInputs:et,separator:L(),containerStyle:"SignInCode__container--OTP",inputStyle:"SignInCode__input SignInCode__input--text",focusStyle:"SignInCode__input--focus"}),l("div",{className:"SignInCode__container--time",children:A("p",{className:"SignInCode__text SignInCode__text--time",children:["(",Xe(C/1e3),")"]})}),l("div",{className:"SignInCode__container--button",children:l(fe,{variant:"contained",size:"large",color:"info",fullWidth:!0,onClick:P,disabled:d,className:"SignInCode__component--button",children:a.button})}),A("div",{className:"SignInCode__container--text",children:[A("p",{className:"SignInCode__text",children:[`${a.question} `,l("span",{onClick:F,className:"SignInCode__text--color SignInCode__text--clickable",children:a.answer})]}),l("p",{className:"SignInCode__text SignInCode__text--clickable",onClick:()=>b(1),children:a.method})]})]})};ke.defaultProps={};const Ct="/CodiShark/assets/iconAlertSignIn.6a29537a.svg",Nt=re.div`
  .SignInForm {
    &__container {
      &--button {
        margin-top: 2.4rem;
...
`,Pe=t=>{const a=ie().signIn.SignInValidation,d=nt(),[r,c]=D.exports.useState(!1),{setSignInStep:n,user:m,setSignInMethod:b}=Q(),{register:h,handleSubmit:_}=be(),{mutateAsync:S,reset:w}=Ce(),{first_name:x,last_name:y,phone:k,email:v}=m!=null?m:{},C=async P=>{try{c(!0),await S({dni:m==null?void 0:m.dni,type:P==null?void 0:P.verifyMethod}),w(),b(P==null?void 0:P.verifyMethod),c(!1),n(2)}catch{c(!1)}},N=P=>{const{id:L,value:E,label:V,name:R,labelExtension:T}=P;return l("div",{children:A("label",{htmlFor:L,children:[l("input",{className:"SignInValidate__container__input",type:"radio",value:E,id:L,...h(R,{required:!0})}),V,l("span",{className:"SignInValidate__text--color",children:T})]})})},I=()=>A("form",{onSubmit:_(C),children:[l("div",{className:"SignInValidate__container__form",children:d.map((P,L)=>{var E,V;return l(N,{id:P.id,name:P.name,value:P.value,label:P.label,labelExtension:P.value==="SMS"?` *** *** ${(E=k==null?void 0:k.slice((k==null?void 0:k.length)-3))!=null?E:""}`:` ********${(V=v==null?void 0:v.slice((v==null?void 0:v.length)-15))!=null?V:""}`},L)})}),l("div",{className:"SignInValidate__container--button",children:l(fe,{type:"submit",variant:"contained",size:"large",color:"info",fullWidth:!0,disabled:r,className:"SignInValidate__component--button",children:a.button})})]});return l(Ot,{className:"SignInValidate",children:A("div",{className:"SignInValidate__container__global",children:[l("div",{className:"SignInValidate__container",children:(()=>A(we,{children:[A("p",{className:"SignInValidate__text--greeting",children:[a.greeting,l("span",{className:"SignInValidate__text--greeting__bold",children:` ${x!=null?x:""} ${y!=null?y:""}`})]}),l("p",{className:"SignInValidate__text--indication",children:a.instructions})]}))()}),I()]})})};Pe.defaultProps={};const kt="/CodiShark/assets/loginImageUser.fd914332.jpg",Pt="/CodiShark/assets/loginImageUser.93122b01.webp",At=re.div`
  .SignIn {
    &__renderList {
      width: 48%;
      margin-left: 4rem;
