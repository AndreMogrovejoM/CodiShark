...
`,{ENTRY_PATH:At}=pe.ROUTES,{INTERVAL:Lt,INITIAL_TIME:Ft}=pe,Le=t=>{const a=re().signIn.SignInFormCode,[l,r]=E.exports.useState(!1),[o,n]=E.exports.useState(""),g=ke(),{setSignInStep:I,user:S,setUser:_}=Q(),{signInMethod:v}=Q(),[,w]=it("user"),{mutateAsync:x,reset:b}=Ce(),{mutateAsync:h,reset:m}=ze(),[B,{start:A}]=kt(Ft,Lt),C=$=>n($),L=async()=>{try{r(!0),x({dni:S==null?void 0:S.dni,type:v}),A(),b(),r(!1)}catch{r(!1)}},O=async()=>{try{r(!0),await h({password:o,dni:S==null?void 0:S.dni}).then($=>{const{access_token:T,user:R}=$!=null?$:{};_(R),w(R),je.setCookie("token",T)}),m(),r(!1),I(0),g(At)}catch{r(!1)}},F=()=>d("span",{className:"SignInCode__container--separator"});return E.exports.useEffect(()=>{A()},[A]),P($t,{className:"SignInCode",children:[d(Pt,{value:o,onChange:C,numInputs:ot,separator:F(),containerStyle:"SignInCode__container--OTP",inputStyle:"SignInCode__input SignInCode__input--text",focusStyle:"SignInCode__input--focus"}),d("div",{className:"SignInCode__container--time",children:P("p",{className:"SignInCode__text SignInCode__text--time",children:["(",at(B/1e3),")"]})}),d(me,{variant:"contained",size:"large",color:"info",fullWidth:!0,onClick:O,disabled:l,className:"SignInCode__container--button",children:a.button}),P("div",{className:"SignInCode__container--text",children:[P("p",{className:"SignInCode__text",children:[a.question,d("span",{onClick:L,className:"SignInCode__text--color SignInCode__text--clickable",children:a.answer})]}),d("p",{className:"SignInCode__text SignInCode__text--clickable",onClick:()=>I(1),children:a.method})]})]})};Le.defaultProps={};const Tt="/CodiShark/assets/iconAlertSignIn.6a29537a.svg",Vt=ae.div`
  .SignInForm {
    &__container {
      &--button {
        padding: 1rem 0;
...
`,de=t=>{const a=re().signIn.SignInFormUser,[l,r,o]=st(),[n,g]=E.exports.useState(!1),{setSignInStep:I,setUser:S}=Q(),{mutateAsync:_,reset:v}=Ue(),{control:w,handleSubmit:x}=xe();return d(Vt,{className:"SignInForm",children:P(ne,{component:"form",noValidate:!0,onSubmit:x(async h=>{try{g(!0);const m={dni:h==null?void 0:h.dni,cod_verifier:h==null?void 0:h.cod,emision_date:h==null?void 0:h.date_begin};await _(m).then(B=>S(B)),v(),g(!1),I(1)}catch{g(!1)}}),children:[P(q,{container:!0,spacing:2,children:[d(q,{item:!0,xs:8,md:8,children:d(le,{name:l.name,control:w,rules:l.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:l.type,label:l.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0,maxLength:l==null?void 0:l.maxLength,InputProps:{endAdornment:d(_e,{position:"end",children:d("img",{className:"SignInForm__icon",src:We,alt:"iconPerson"})})}}})})}),d(q,{item:!0,xs:4,md:4,children:d(le,{name:r.name,control:w,rules:r.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:r.type,label:r.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0,maxLength:r==null?void 0:r.maxLength,InputProps:{endAdornment:d(_e,{position:"end",children:d("img",{className:"SignInForm__icon",src:Tt,alt:"iconAlert"})})}}})})}),d(q,{item:!0,xs:12,md:12,children:d(le,{name:o.name,control:w,rules:o.rules,defaultValue:"",render:({field:h,fieldState:m})=>d(ue,{field:h,fields:m,config:{type:o.type,label:o.label,variant:"outlined",margin:"dense",fullWidth:!0,focused:!0}})})})]}),d(ne,{children:d(me,{type:"submit",variant:"contained",size:"large",color:"info",fullWidth:!0,disabled:n,className:"SignInForm__container--button",children:a.button})})]})})};de.defaultProps={};const Et=ae.div`
  .SignInValidate {
    &__container {
      &--button {
        padding: 1rem 0;
...
`,{ENTRY_PATH:Wt}=pe.ROUTES,Te=t=>{const{isAnonymous:a,signInStep:l}=Q(),r=re().signIn.SignInFormUser,o=ke();E.exports.useEffect(()=>{if(!a){o(Wt);return}},[a,o]);const n=()=>{switch(l){case 0:return d(de,{});case 1:return d(Fe,{});case 2:return d(Le,{});default:return d(de,{})}},g=()=>P(Pe,{children:[d("img",{src:Me,alt:r.altLogo,width:188}),d("h1",{className:"SignIn__title",children:l!==2?r.title.toUpperCase():r.titleAlt.toUpperCase()}),d("p",{className:"SignIn__subtitle",children:l!==2?r.subtitle:r.subtitleAlt}),l===2&&d("p",{className:"SignIn__subtitle",children:r.subtitleAltTwo})]}),I=()=>d("p",{className:"SignIn__container--copyright",children:r.copyright});return d(Dt,{className:"SignIn",children:P(q,{container:!0,component:"main",className:"SignIn__container",children:[d(q,{item:!0,xs:!1,sm:4,md:6,className:"SignIn__image",children:(()=>P("div",{className:"SignIn__renderList",children:[d("h2",{className:"SignIn__renderList--h2",children:r.benefitTitle}),d("h1",{className:"SignIn__renderList--h1",children:r.benefitSubTitle}),P("ul",{className:"SignIn__renderList--ul",children:[d("li",{className:"SignIn__renderList--h2",children:r.ul1}),d("li",{className:"SignIn__renderList--h2",children:r.ul2}),d("li",{className:"SignIn__renderList--h2",children:r.ul3}),d("li",{className:"SignIn__renderList--h2",children:r.ul4})]})]}))()}),P(q,{item:!0,xs:12,sm:8,md:6,component:Ge,elevation:4,square:!0,container:!0,alignItems:"center",justifyContent:"center",flexDirection:"column",children:[P(ne,{className:"SignIn__container--form",children:[d(ne,{className:"SignIn__container--center   SignIn__container--content",children:g()}),n()]}),I()]})]})})};Te.defaultProps={};const Zt=Te;export{Zt as default};
