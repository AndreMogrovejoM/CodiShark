import{B as x}from"./Button.95393443.js";import{r as Q,S as W}from"./rightArrow.51013e20.js";import{u as S,g as H}from"./i18n.hooks.009c0aa7.js";import{s as T,a,j as s,C as E,u as U,G as q,ag as G,aA as J,r as f}from"./index.9ad24540.js";import{f as z}from"./file-download.9541e5f9.js";import{e as X,f as Z,c as ee,g as te,h as ae}from"./administrator.service.hooks.1e007cd0.js";import{P as ne}from"./PaginationCustom.f80967ca.js";import{T as ie}from"./Table.1a47c650.js";import{y as se,z as re,A as oe}from"./validations.utils.034110a4.js";import{n as I}from"./common.utils.106d572f.js";import{L as le}from"./Layout.container.b6dc7091.js";const me=T.div`
  .SelectComponent {
    &__component {
...
`,ce=t=>a(ne,{...t}),M=t=>{const{data:e,columns:n,onRowClicked:o,progressPending:r}=t,{totalRows:m,setPage:d,page:i}=t,u=S().global.table.TablePaymentUser.Pagination;return a(L,{className:"AdminPaymentTable",children:a(ie,{columns:n,data:e,paginationPerPage:se,paginationRowsPerPageOptions:re,onRowClicked:o,paginationComponent:h=>ce({...h,totalRows:m,setPage:d,page:i,t:u}),progressPending:r})})};M.defaultProps={};const de="/CodiShark/assets/detailsPay.a840b3ee.svg",{BREAKPOINTS:O}=E,pe=T.div`
  .PaymentDetails {
    &__renderActions {
      display: flex;
      gap: 1.6rem;
