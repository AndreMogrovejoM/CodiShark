...
`,he={width:"20.4rem",flexShrink:0,"& .MuiDrawer-paper":{width:"20.4rem",boxSizing:"border-box",backgroundColor:"var(--palette-deepBlue)",color:"white"}},{NO_AUTH_PATH:Dr,USER_PAYMENT_LIST:zr,ADMIN_ENTRY_PATH:Br}=ye.ROUTES,{USER_CLIENT_LIST:Or,USER_PAYMENT_DETAILS:Ar}=ye.ROUTES,{ADMIN_PAYMENT_LIST:Fr,ENTRY_PATH:Wr}=ye.ROUTES,Ur="./LogoKonectaSidebar.png",Ve=e=>{const{open:t=!0,onClose:r}=e,n=yt().global.sideBar,a=tt(),{setSignInStep:p,setUser:l,user:u}=mt(),{selectedIndex:m}=Oe(),{mutateAsync:d,reset:v}=ft(),[,T]=rt("user"),{first_name:b,last_name:E,mother_last_name:g}=u!=null?u:{},[x,$]=h.exports.useState(!0),w=_=>{console.log(m.current,_),$(!x)},R=async()=>{try{d(),v(),p(0),T(""),l(void 0),ht.setCookie("token",""),a(Dr),document.location.reload()}catch(_){console.warn(_)}},f=(_,k,y,F)=>L(nt,{children:[L(pe,{onClick:I=>{a(y),w(_),m.current=_},sx:{padding:"1.2rem 2.4rem"},className:"Sidebar__listButton",children:[o(ue,{className:"Sidebar__list--icon",children:o(ge,{sx:{color:"white"},className:m.current===_?"Sidebar__active":"",fontSize:"large"})}),o(me,{children:o("h3",{className:m.current===_?"Sidebar__active":"",children:k})})]},_),F&&o(Pt,{in:x,timeout:"auto",unmountOnExit:!0,children:o(de,{component:"div",disablePadding:!0,children:L(pe,{sx:{pl:2},children:[o(ue,{children:o(ge,{})}),o(me,{primary:"Starred"})]})})})]}),N=()=>L(pe,{onClick:R,sx:{padding:"1.2rem 2.4rem"},className:"Sidebar__listButton",children:[o(ue,{className:"Sidebar__list--icon",children:o(We,{sx:{color:"white"},fontSize:"medium"})}),o(me,{children:o("h3",{children:n.logout})})]});return o(Mr,{className:"Sidebar",children:o(Ht,{anchor:"left",open:t,onClose:r,className:"Sidebar__drawer",sx:he,variant:"permanent",children:L(de,{component:"nav","aria-labelledby":"nested-list-subheader",sx:he,subheader:o("div",{className:"Sidebar__header",children:L("div",{className:"Sidebar__header-text",children:[o("img",{className:"Sidebar__icon",src:Ur,alt:"logoKonecta",width:140}),L("div",{className:"Sidebar__sectionContainer",children:[o("img",{src:kr,alt:"iconPersonSideBar"}),L("div",{children:[o("h2",{children:b}),o("h4",{children:`${E} ${g}`})]})]})]})}),children:[o(de,{component:"nav","aria-labelledby":"nested-list-subheader",sx:he,subheader:o("div",{className:"Sidebar__footer",children:o("div",{className:"Sidebar__footer-text",children:o("div",{className:"Sidebar__sectionContainerFooter",children:L("div",{className:"Sidebar__footerList",children:[o("h2",{className:"Sidebar__footerListTitle",children:n.title}),L("div",{className:"Sidebar__iconFooter",children:[o(Fe,{}),o("p",{children:"0800 1652 1254"})]}),L("div",{className:"Sidebar__iconFooter",children:[o(Ue,{}),o("p",{children:"info@b12.com"})]}),L("div",{className:"Sidebar__iconFooter",children:[o(Ae,{}),o("p",{children:n.direction})]}),o("a",{href:"google.com",children:"www.b12.com"})]})})})})}),f(0,n.start,Wr),f(1,n.startAdmin,Br),f(2,n.myPayments,zr),f(3,n.myClients,Or),f(4,"Detalles pago",Ar),f(5,"Lista de pagos Admin",Fr),o("div",{className:"Sidebar__divider"}),N()]})})})};Ve.defaultProps={};const jr=Ne.div`
  width: 100%;
  height: 100vh;
  display: flex;
  position: relative;
...
`,Vr=e=>{const{children:t}=e,{isLoading:r}=Oe();return L(jr,{className:"LayoutContainer",children:[o(Ve,{}),o("main",{className:"LayoutContainer__children",children:t}),o(ot,{isLoading:r})]})};Vr.defaultProps={};export{Vr as L,ee as a,ge as d,G as i,Z as r,Oe as u};
