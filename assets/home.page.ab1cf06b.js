import{A as st}from"./AdministratorPanel.container.a80021b3.js";import{s as S,j as u,a as e,af as se,a4 as lt,a2 as ct,E as me,r as E,C as D,ag as ee,G as X}from"./index.83119aac.js";import{u as O,g as dt}from"./i18n.hooks.6534aa8f.js";import{u as H,r as mt,i as ut,b as ht,L as ft}from"./Layout.container.ed17b99b.js";import{l as pt}from"./logoKonecta.2d72f0fc.js";import{p as _t,q as gt,r as bt,M as we}from"./auth.service.hooks.bd0577ba.js";import{u as xe,a as yt}from"./users.service.hooks.55c518bd.js";import{B as Ce}from"./Box.5cc151ff.js";import{B as ce}from"./Button.ba91d73e.js";import{T as vt}from"./Table.b9970ae1.js";import{e as wt,f as xt}from"./validations.utils.44a2d7fc.js";import{g as Ct,a as Nt}from"./common.utils.cf38e105.js";import{S as G}from"./SkeletonComponent.01cfd51c.js";import{d as Pt,a as It}from"./Remove.5b249fd3.js";import St from"./500.page.e068e1f1.js";import"./administrator.service.hooks.0ee06101.js";const kt="/CodiShark/assets/fotoMujerOne.cadd13a3.svg",Tt=S.div`
  position: relative;
  max-width: 32rem;
  max-height: 30rem;
  width: 100%;
...
`,{CCI_ACCOUNT_NUMBER:an,ACCOUNT_NUMBER:on}=D,ze=a=>{const n=O().signIn.InformationClient,{userDebt:o}=a,[l,s]=E.exports.useState(!1),[d,m]=E.exports.useState(!1),[b,f]=E.exports.useState(),{id:p,amount_cancellation:g}=o!=null?o:{},{mutateAsync:y,reset:N,isLoading:w}=xe(),{setIsLoading:k,setPaymentStatus:R}=H();E.exports.useEffect(()=>{k(w)},[w,k]);const z=()=>{R("NONE"),m(!d)},x=async()=>{R("NONE");try{g&&p&&(await y({amount:g,debtId:p}).then(C=>{const{data:v}=C!=null?C:{},{operation_number:M}=v!=null?v:{};f(M)}).catch(),s(!l),N())}catch(C){R("ERROR"),console.log(C)}};return u(rn,{className:"InformationClient",children:[u("div",{className:"InformationClient__section1",children:[e("h2",{className:"InformationClient__title",children:n.title}),e("h2",{className:"InformationClient__subtitle",children:n.subtitle}),e("img",{className:"InformationClient__image1",src:Mt,alt:"ImagePayInformation"}),e("h2",{className:"InformationClient__subtitle2",children:n.subtitle2}),u("div",{className:"InformationClient__imageSection",children:[e("img",{className:"InformationClient__image2",src:zt,alt:"iconVisaInformation"}),e("img",{className:"InformationClient__image3",src:Et,alt:"iconMasterCardInformation"})]}),e(ce,{className:"InformationClient__button",variant:"contained",disabled:w,onClick:z,children:e("h3",{className:"InformationClient__text1",children:n.button.toLocaleUpperCase()})})]}),e("img",{className:"InformationClient__line",src:jt,alt:"lineInformation"}),u("div",{className:"InformationClient__section2",children:[e("h2",{className:"InformationClient__title2",children:n.title2}),u("div",{className:"InformationClient__container--content",children:[e("h2",{className:"InformationClient__subtitle3",children:n.subtitle3}),e("h2",{className:"InformationClient__subtitle4",children:n.subtitle4}),e("p",{className:"InformationClient__cuenta1",children:on}),e("h2",{className:"InformationClient__subtitle4",children:n.subtitle5}),e("p",{className:"InformationClient__cuenta1",children:an}),e("p",{className:"InformationClient__paragraph",children:n.paragraph}),e("h2",{className:"InformationClient__subtitle6",children:n.subtitle6})]}),e("div",{className:"InformationClient__container--button",children:e(ce,{className:"InformationClient__button2",variant:"contained",onClick:x,disabled:w,children:e("h3",{className:"InformationClient__text2",children:n.button2.toLocaleUpperCase()})})})]}),e(Oe,{open:d,setOpen:m,operationNumber:b,userDebt:o}),e(Ee,{open:l,setOpen:s,operationNumber:b,userDebt:o})]})};ze.defaultProps={};const sn="/CodiShark/assets/rejectedImage.25910230.svg",ln=S.div`
  .PaymentRejected {
    &__container {
      width: 100%;
      display: flex;
...
`,De=a=>{const{rowsPerPage:n,rowCount:o}=a,{currentPage:l,onChangePage:s}=a,d=O().global.table.TableDebtUser.Pagination,m=Nt(o,n),b=Ct(m),p=l*n-n+1,g=l===1,y=l===m,N=E.exports.useCallback(()=>s(l-1),[l,s]),w=E.exports.useCallback(()=>s(l+1),[l,s]),k=E.exports.useCallback(v=>s(v),[s]),R=v=>e("div",{...v,children:v==null?void 0:v.value}),z=d.legend(p,o,o),x=v=>`Pagination__text--bold ${v?"Pagination__text--disabled":""}`,C=v=>`Pagination__container--numbers ${v===l?"Pagination__container--numbers-activated":""}`;return e(hn,{className:"Pagination",children:u("div",{className:"Pagination__container",children:[e("p",{className:"Pagination__text",children:z}),u("div",{className:"Pagination__container--pagination",children:[e("button",{className:x(g),"aria-disabled":g,onClick:N,disabled:g,children:d.back}),b.map((v,M)=>e(R,{value:v,className:C(v),onClick:()=>k(v)},M)),e("button",{className:x(y),"aria-disabled":y,onClick:w,disabled:y,children:d.next})]})]})})};De.defaultProps={};const{BREAKPOINTS:fn}=D,Z=S.div`
  .DebtTable {
    &__container {
      &--middle {
        display: flex;
